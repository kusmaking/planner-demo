...
const STORAGE_KEYS = {
  employees: "planner_employees_v2",
  projects: "planner_projects_v2",
  entries: "planner_entries_v2",
  auditLog: "planner_audit_v2",
  notificationLog: "planner_notifications_v2",
  startDate: "planner_start_v2",
  viewMode: "planner_view_v2"
};
...
const DEFAULT_ENTRIES = [
  ...
  { id: crypto.randomUUID(), project_id: projectIdByName("Training"), employee_name: "Aliaksandr Skliarenka", role: "Mekaniker 1", start_date: "2026-01-08", end_date: "2026-01-09", notes: "Training" },
  ...
  { id: crypto.randomUUID(), project_id: projectIdByName("Åsgard A 18CL900"), employee_name: "Tor-Marius Sande", role: "Mekaniker 2", start_date: "2026-03-02", end_date: "2026-03-13", notes: "Åsgard A" }
];

const DEFAULT_AUDIT_LOG = [
  { id: crypto.randomUUID(), user_name: "Olis Hansen", action_text: "Initialiserte planleggingsverktøy", created_at: "2026-04-14T07:00:00.000Z" }
];
